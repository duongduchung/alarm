package com.example.duchung.alarm;
...
import static com.example.duchung.alarm.MyDatabase.getInstance;
...
public class AddAlarmActivity extends AppCompatActivity {
    ...
    private void addEvents() {
        ...
        txtAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alarm.setStatus(1);
                getInstance(AddAlarmActivity.this).add(alarm);
    ...
    private void showPopupDialog() {
        ...
        popupMenu.getMenuInflater().inflate(R.menu.menurepeat, popupMenu.getMenu());
